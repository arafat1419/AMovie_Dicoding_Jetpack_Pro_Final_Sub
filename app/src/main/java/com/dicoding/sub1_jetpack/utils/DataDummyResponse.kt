...
object DataDummyResponse {
    ...
    fun generateDummyShows(): List<TvResponse> {
        val listShows = ArrayList<TvResponse>()
    ...
    fun generateDummyMovieTrailer(): List<TrailerResponse> {
        val listTrailerMovie = ArrayList<TrailerResponse>()
    ...
    fun generateDummyTvShowTrailer(): List<TrailerResponse> {
        val listTrailerTvShow = ArrayList<TrailerResponse>()
